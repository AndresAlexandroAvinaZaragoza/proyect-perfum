                ...
                <div class="card card-custom rounded-4">
                    <div class="card-body">
                        <form id="filtros" method="GET" action="{{ route('cliente.show', $cliente->id) }}" class="d-flex gap-3 w-100">
                            ...
                            <select class="form-select w-auto auto-submit" name="estatus">
                            ...
                            <div class="card-content">
                                ...
                                <div class="bloque-total">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('deuda.show', $deuda->id) }}" class="btn btn-outline-warning"> Detalles </a>
    ...
    document.getElementById('search').addEventListener('input', function(){
        ...
        timer = setTimeout(() => {
            ...
            .then(html => {
                ...
                const nuevaTabla =
                    doc.querySelector('#tabla-deudas').innerHTML;

                document.querySelector('#tabla-deudas').innerHTML =
                    nuevaTabla;
